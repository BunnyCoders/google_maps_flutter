...
class _PolylineScreenState extends State<PolylineScreen> {
  ...
  double _originLatitude = 23.265310789940852, _originLongitude = 77.47129242231686;
  double _destLatitude = 23.268806958728696, _destLongitude = 77.4741201831405;
  Map<MarkerId, Marker> markers = {};
  Map<PolylineId, Polyline> polylines = {};
  List<LatLng> polylineCoordinates = [];
  PolylinePoints polylinePoints = PolylinePoints();
  // String googleAPiKey = "AIzaSyDQ2c_pOSOFYSjxGMwkFvCVWKjYOM9siow";
  String googleAPiKey = "AIzaSyA30ry8XW44Oduwa0RaBifrUZssmvcoIUM";
